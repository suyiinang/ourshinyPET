...
**Topic Modelling**
- Topic Modelling help users interpret the topics that has been fit to a corpus of Airbnb data. 
- The left panel shows a global view of topic model to show the prevalence of each topic, and how topics relat to each other.
