...
main_bottomsize: 0.1
title: "**ShinyPET**: A **P**redictive, **E**xploratory and **T**ext RShiny Application using Airbnb data"
...
library(knitr)
knitr::opts_chunk$set(echo = FALSE,  fig.pos = "H", fig.align='left')
```
