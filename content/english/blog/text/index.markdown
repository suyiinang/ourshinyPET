...
-   Legend
    ...
    To reposition the legend, use tm\_layout(legend.position=c(“right,”“bottom”)).To set the legend outside, tm\_layout(legend.outside=TRUE, legend.outside.position=“right”) can be used.
    To set a title for the map, use tm\_layout(“Title”).
