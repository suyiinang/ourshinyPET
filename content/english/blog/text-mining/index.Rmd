...
ggplot(airbnbwords,aes(frequency/total,fill=neighbourhood_group_cleansed))+
  geom_histogram() +
...
Trouble with github 
_Error in git2r::add(repo, paths) : 
  Error in 'git2r_index_add_all': the index is locked; this might be due to a concurrent or crashed process_
